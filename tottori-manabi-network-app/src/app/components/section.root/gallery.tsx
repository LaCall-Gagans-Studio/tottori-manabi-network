...
const pickupInternships: Internship[] = [
  {
    ...
    imageUrl: 'https://tottori-yawaraka-infos.org/img/8HzqShngN.webp',
    ...
    <section className="w-full">
      ...
      >
        <h2 className="text-center pb-10 relative">
          ...
          <img
            src="https://www.tottori-internship.net/user/common/images/internship_pickup.png"
            alt="Pick up!"
            className="absolute -top-4 lg:-top-16 right-1/2 translate-x-40 w-20 w-12"
          />
        </h2>
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col flex-grow">
                      ...
                      <h3 className="font-bold text-ws-black hover:underline mb-2 flex-grow">
                        <a href={item.programUrl}>{item.title}</a>
                      </h3>
      ...
      <div className="relative bg-cover bg-center h-auto w-full">
        ...
        />
        <img
          src="https://www.tottori-internship.net/user/common/images/area_search_select.png"
          alt="探したいエリアを選択!"
      ...
      <div className="py-12 bg-ws-white">
        <div className="max-w-5xl mx-auto px-4">
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-6">
            <li>
              <a href="https://www.tottori-internship.net/manual/#a_subsidy">
                <img
            ...
            <li>
              <a href="https://www.tottori-internship.net/accounts/signup/">
                <img
